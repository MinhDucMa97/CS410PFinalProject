...
public class Tree_Node {
    ...
    public void removeAll_List(){head = null;}


    //Remove a single node based on provider name and service name in a list of a type
    /*public void removeNode_List(String serviceName, String providerName){
        if(head == null){
            System.out.println("This list is empty");
        }
        if(head.serviceName.equals(serviceName) && head.providerName.equals(providerName)){
            List_Node temp = this.head;
            temp.next =
        }
        else{
            removeNode_List(head, serviceName,providerName);
        }
    }


    public List_Node removeNode_List(List_Node head,String serviceName, String providerName){
        if(head == null){
            System.out.println("This item does not exist in this list");
            return null;
        }
        if(serviceName.equals(head.serviceName) && providerName.equals(head.providerName) && head.next == null){
            ...
            removeNode_List(head.next,serviceName,providerName);
        }
        else if(serviceName.equals(head.serviceName) && providerName.equals(head.providerName) && head.next != null){
